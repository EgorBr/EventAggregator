                    ...
                    case .success(let value):
                        ...
                        for (_, subJSON) in json["message"] {
                            if idArr.contains(subJSON["title"].stringValue) {}
                                ...
                                refEvent.child("\(uds.value(forKey: "globalCityKey") as! String)/Events/\(key)/short_title").setValue(subJSON["title"].stringValue)
                                refEvent.child("\(uds.value(forKey: "globalCityKey") as! String)/Events/\(key)/description").setValue(subJSON["description"].stringValue)
                                refEvent.child("\(uds.value(forKey: "globalCityKey") as! String)/Events/\(key)/is_free").setValue("false")
                                refEvent.child("\(uds.value(forKey: "globalCityKey") as! String)/Events/\(key)/start_event").setValue(self.decoder.dfPonam(date: subJSON["min_date"].stringValue))
                                refEvent.child("\(uds.value(forKey: "globalCityKey") as! String)/Events/\(key)/place").setValue(subJSON["subevents"][0]["venue"]["title"].stringValue)
                                refEvent.child("\(uds.value(forKey: "globalCityKey") as! String)/Events/\(key)/categories").setValue(subJSON["categories"][0]["title"].stringValue)
                                refEvent.child("\(uds.value(forKey: "globalCityKey") as! String)/Events/\(key)/price").setValue("от \(subJSON["min_price"].stringValue) до \(subJSON["max_price"].stringValue)")
                                refEvent.child("\(uds.value(forKey: "globalCityKey") as! String)/Events/\(key)/image").setValue("http://media.cultserv.ru/i/300x200/\(subJSON["subevents"][0]["image"].stringValue)")
                                refEvent.child("\(uds.value(forKey: "globalCityKey") as! String)/Events/\(key)/Target").setValue("ponaminalu")
                                refEvent.child("\(uds.value(forKey: "globalCityKey") as! String)/Events/\(key)/eticket_possible").setValue(subJSON["eticket_possible"].stringValue)
                                }
                        }
